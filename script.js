...
const processSteps = [
    { name: "Order Recirved", duration: 5, progress: 0 },
    { name: "Preparing", duration: 10, progress: 20 },
    { name: "In The Oven", duration: 15, progress: 40 },
    { name: "Quality Check", duration: 20, progress: 60 },
    { name: "Out For Delivery", duration: 25, progress: 80 },
    { name: "Delivered", duration: 30, progress: 100 },
];
...
function updateOrderSummary() {
    ...
    let total = basePrice + toppingPrice + deliveryFee;
...
function getStatusMessage(stepIndex) {
    const messages = [
        "We've recieved your order and it has been sent to the kitchen.",
        "Our chefs are preparing your pizza with fresh ingredients.",
        "Your Pizza is now baking in our brick oven at 700 degrees F.",
...
function resetProcess() {
    ...
    currentStatus.textContent = "Order Recived";
    steps.forEach((step) => {
